import re
file = open("/Users/damirnurmagambetov/Desktop/PP2_Labs/Lab_5/regex.py", "r")
content = file.read()

# Task1
# Write a Python program that matches a string that has an 'a' followed by zero or more 'b''s.
result1 = re.fullmatch(r'ab*', content)

# Task2
# Write a Python program that matches a string that has an 'a' followed by two to three 'b'.
pattern = r'ab{2,3}'
result2 = re.fullmatch(pattern, content)
...
pattern = r'a.+b$'
result5 = re.fullmatch(pattern, content)
...
pattern = r'(?=[A-Z])'
result8 = re.split(pattern, content)
...
answer10 = re.sub(pattern, replace, result10).lower()
